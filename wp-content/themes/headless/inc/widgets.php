 ...
 */
add_filter( 'dynamic_sidebar_params', 'overstrap_widget_classes' );

if ( ! function_exists( 'overstrap_widget_classes' ) ) {
	/**
	 ...
	 * @return array $params
	 */
	function overstrap_widget_classes( $params ) {
...
} // endif function_exists( 'overstrap_widget_classes' ).

add_action( 'widgets_init', 'overstrap_widgets_init' );

if ( ! function_exists( 'overstrap_widgets_init' ) ) {
	/**
	 * Initializes themes widgets.
	 */
	function overstrap_widgets_init() {
		register_sidebar(
			array(
				'name'          => __( 'Right Sidebar', 'overstrap' ),
				'id'            => 'right-sidebar',
				'description'   => __( 'Right sidebar widget area', 'overstrap' ),
		...
		// register_sidebar(
		// 	array(
		// 		'name'          => __( 'Left Sidebar', 'overstrap' ),
		// 		'id'            => 'left-sidebar',
		// 		'description'   => __( 'Left sidebar widget area', 'overstrap' ),
		// 		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		// 		'after_widget'  => '</aside>',
		// 		'before_title'  => '<h3 class="widget-title">',
		// 		'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Full', 'overstrap' ),
				'id'            => 'footerfull',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'overstrap' ),
...
} // endif function_exists( 'overstrap_widgets_init' ).

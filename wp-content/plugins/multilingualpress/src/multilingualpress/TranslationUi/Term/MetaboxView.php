...
final class MetaboxView implements Metabox\View
{
    ...
    private function remoteTermUrl(): string
    {
        ...
        $term = get_term_by('term_taxonomy_id', $remoteTerm->term_id, $remoteTerm->taxonomy);
        $termId = $term->term_id ?? $remoteTerm->term_id;

        return (string)get_edit_term_link($termId, $remoteTerm->taxonomy);
    }
}
